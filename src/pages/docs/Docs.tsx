      ...
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {[
            ...
            // {
            //   title: 'Pitch Deck',
            //   description: 'Review the current presentation flow for demos, partners, and investor storytelling.',
            //   path: '/pitch',
            //   cta: 'Open Pitch Deck'
            // },
            // {
            //   title: 'Social Kit',
            //   description: 'Browse social content layouts and export-ready creative assets for Forge8004.',
            //   path: '/social-kit',
            //   cta: 'Open Social Kit'
            // }
          ].map((resource) => (
        ...
        <div className="glass-panel p-8 space-y-8">
          ...
          <div className="pt-8 border-t border-border-subtle">
            ...
            <p className="text-[11px] font-mono text-zinc-400 uppercase leading-relaxed">
              ...
              It might mention "Momentum," "RSI Divergence," or "Support
              Levels." Understanding the reasoning helps you trust the
              autonomous loop.
            </p>
          </div>
        </div>
